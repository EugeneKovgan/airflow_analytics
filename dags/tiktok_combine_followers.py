...
def get_tiktok_followers_combine_stats(**kwargs: Any) -> None:
    parser_name = 'Tiktok Followers Combine'
    status = 'success'
    platform = 'tiktok'
...
tiktok_followers_combine_task = PythonOperator(
    task_id='get_tiktok_followers_combine_stats',
    python_callable=get_tiktok_followers_combine_stats,
    provide_context=True,
    dag=dag,
)

tiktok_followers_combine_task
